...
const FAQS = [
  { q: 'Is Prompt Beast free to use?', a: 'Yes! Prompt Beast offers a generous free tier powered by Hugging Face open-source models. For GPT-4o access, provide your own OpenAI API key or upgrade to Pro.' },
  { q: 'Which AI models does Prompt Beast support?', a: 'We support OpenAI GPT-4o Mini and multiple Hugging Face models: Qwen 2.5 7B, Mistral 7B, DeepSeek R1, Phi 3.5 Mini, and Zephyr 7B.' },
  ...
  { q: 'What makes these prompts better than writing them myself?', a: 'Prompt Beast adds proven prompt engineering techniques: role assignment, context layering, output format specs, chain-of-thought triggers, and category-specific patterns.' },
